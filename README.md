...
Download <a href="https://github.com/mortenblaa/maya-tweener/raw/master/tweener-install.py" download="tweener-install.py">tweener-install.py</a> (right-click, save link as...) and drag 
